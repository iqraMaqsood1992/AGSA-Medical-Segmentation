...
class Config_Synapse:
    # GENERIC paths - users will modify
    data_path = "./data/Synapse/"  # NOT /home/iqra/DMA/data/Synapse/
    save_path = "./checkpoints/Synapse/"
    result_path = "./results/Synapse/"
    
    load_path = save_path + "/xxx.pth"
    pre_trained = True  # Change this to True
    load_path = "./checkpoints/Synapse/  # Set this to your checkpoint path
